...
namespace EncodeforDicoms
{
    public partial class DisplayForm : Form
    {
        ...
        {
            string paName = _file.Dataset.GetSingleValueOrDefault(DicomTag.PatientName, "");
            string pPatientID = _file.Dataset.GetSingleValueOrDefault(DicomTag.PatientID, "");
            string studyUID = _file.Dataset.GetSingleValueOrDefault(DicomTag.StudyInstanceUID, "");
            string pStudyDescription = _file.Dataset.GetSingleValueOrDefault(DicomTag.StudyDescription, "");
            string pInstitutionName = _file.Dataset.GetSingleValueOrDefault(DicomTag.InstitutionName, "");
            string pInstitutionAddress = _file.Dataset.GetSingleValueOrDefault(DicomTag.InstitutionAddress, "");
            patientName.Parent = pbDisplay;
            patientName.BackColor = Color.Transparent;
            patientName.Text = paName.ToString();
            patientID.Parent = pbDisplay;
            patientID.BackColor = Color.Transparent;
            patientID.Text = pPatientID.ToString();
            StudyInstanceUID.Parent = pbDisplay;
            StudyInstanceUID.BackColor = Color.Transparent;
            StudyInstanceUID.Text = studyUID.ToString();
            StudyDescription.Parent = pbDisplay;
            StudyDescription.BackColor = Color.Transparent;
            StudyDescription.Text = pStudyDescription.ToString();
            InstitutionName.Parent = pbDisplay;
            InstitutionName.BackColor = Color.Transparent;
            InstitutionName.Text = pInstitutionName.ToString();
            InstitutionAddress.Parent = pbDisplay;
            InstitutionAddress.BackColor = Color.Transparent;
            InstitutionAddress.Text = pInstitutionAddress.ToString();
            try
            {
